      ...
      <tr id="row-${barcodeEscaped}" class="${rowClass}">
        ...
        <td class="col-action" style="text-align:center;">
          <div style="display:inline-flex; gap:4px; align-items:center; justify-content:center; flex-wrap:nowrap;">
            <button class="btn btn-secondary btn-sm" onclick="openProductHistoryModal('${barcodeEscaped}')" style="padding:3px 6px; font-size:10.5px; font-weight:700; color:#a5b4fc;" title="Değişiklik Geçmişi ve Geri Alma (Undo)">
              🕒 Geçmiş
            </button>
            <button class="btn btn-secondary btn-sm" onclick="openProductEditModal('${barcodeEscaped}')" style="padding:3px 6px; font-size:10.5px; font-weight:700; color:#fbbf24;" title="Ürün Adı ve Fiyatını Düzenle">
              ✏️ Düzenle
            </button>
...
// ==========================================================================
// 10. ÜRÜN DEĞİŞİKLİK GEÇMİŞİ (AUDIT TRAIL) & TEK TIKLA GERİ ALMA (UNDO)
// ==========================================================================
...
// 11. HIZLI ÜRÜN DÜZENLEME (INLINE EDIT) MODALI
...
// 12. VEGAWIN SENKRONİZASYON GEÇMİŞİ & TOPLU GERİ ALMA (SYNC ROLLBACK)
